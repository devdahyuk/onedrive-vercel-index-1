...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'backup@wbwuo.onmicrosoft.com',
  ...
  title: "YCISCQ PO Archive",

  // The folder that you are to share publicly with onedrive-vercel-index. Use '/' if you want to share your root folder.
  baseDirectory: '/YCIS_PO',
  ...
  email: 'mailto:dahyukc@gmail.com',
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/devdahyuk',
    },
    {
      name: 'Powered by CloudFlare',
